...
CURATED_RESOURCES: dict[int, dict] = {
    1: {
        ...
        "resources": [
            ...
            {
                "title": "Princeton University: Cognitive Architectures for Language Agents",
                "url": "https://www.youtube.com/watch?v=ayzKMyUMh1I",
                "type": "video",
                "creator": "Princeton University",
                "description": "Direct from the CoALA authors — agent architecture organized by memory, action space, and decision loops.",
            },
        ],
    },
    2: {
    ...
    3: {
        ...
        "resources": [
            ...
            {
                "title": "Stateful Agents — Full Workshop with Charles Packer (MemGPT/Letta Creator)",
                "url": "https://www.youtube.com/watch?v=E0k9Ppq6yXY",
                "type": "video",
                "creator": "Charles Packer (Letta)",
                "description": "Definitive workshop from the MemGPT creator on how agents form memories, adapt, and manage context.",
            },
            {
                "title": "LLMs as Operating Systems: Agent Memory — Free Course",
                "url": "https://learn.deeplearning.ai/courses/llms-as-operating-systems-agent-memory",
                "type": "course",
                "creator": "DeepLearning.AI + Letta",
                "description": "Memory hierarchy, virtual context, multi-agent memory sharing, and the MemGPT OS metaphor.",
            },
        ],
    },
    4: {
        ...
        "resources": [
            ...
            {
                "title": "CMU Advanced NLP: Tool Use and LLM Agent Basics (Lecture 15)",
                "url": "https://www.youtube.com/watch?v=a3SjRsqV9ZA",
                "type": "video",
                "creator": "Graham Neubig (CMU)",
                "description": "Graduate-level lecture on tool use fundamentals and environment representation from a top NLP program.",
            },
        ],
    },
    5: {
        ...
        "resources": [
            ...
            },
            {
                ...
                "description": "3+ hour free course on LangGraph's graph-based multi-agent orchestration from scratch with Python.",
            },
            {
                ...
                "type": "blog",
                "creator": "Anthropic",
                "description": "Influential guide arguing for simple, composable patterns over complex frameworks. Distinguishes workflows from agents.",
            },
        ],
    },
    6: {
